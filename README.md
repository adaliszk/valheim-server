...
- `0.206.5` `0.206` - the server version released on 14/12/2021
- `0.205.5` `0.205` - the server version released on 25/11/2021
- `bepinex-5.4.1700` `bepinex-5.4.17` `bepinex-5.4` `bepinex` - latest server using [denkinson's BepInEx](https://valheim.thunderstore.io/package/denikson/BepInExPack_Valheim) mod loader
