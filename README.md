...
- `0.153.2` `0.150` - the server version released on 12/05/2021
- `0.150.3` `0.150` - the server version released on 19/04/2021
- `bepinex-5.4.1000` `bepinex-5.4.10` `bepinex-5.4` `bepinex` - latest server using [denkinson's BepInEx](https://valheim.thunderstore.io/package/denikson/BepInExPack_Valheim) mod loader
